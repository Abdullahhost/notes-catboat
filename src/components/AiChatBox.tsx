    ...
    return (
        <>
            <div ref={toggleRef} className={cn("bottom-0 right-0 z-40 w-full max-w-[500px] p-1 xl:right-24 ", open ? "fixed" : "hidden")}>
                ...
                <div style={{ background: "linear-gradient(#fff1 40% , #0009)" }} className="h-[600px] flex flex-col rounded-md border-rborder-t dark:border-neutral-700 backdrop-blur-[2px] shadow-2xl
